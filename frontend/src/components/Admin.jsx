  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 animate-in fade-in duration-500 pb-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-slate-900 p-6 rounded-2xl shadow-lg border border-slate-800 text-white relative overflow-hidden">
        ...
        <div>
          <h2 className="text-2xl font-black flex items-center gap-2"><ShieldAlert className="text-red-500" /> Admin Demo Paneli <DemoBadge /></h2>
          <p className="text-slate-400 text-sm mt-1">O'zbekiston bo'yicha fermer xo'jaliklari va IoT datchiklar uchun statik demo ko'rinish.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex flex-col min-h-[300px]">
          ...
          <div className="overflow-x-auto">
            <BarChart width={760} height={240} data={statsData}>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
          ...
          <div className="space-y-4">
            ...
            <div className="p-3 bg-red-50 rounded-xl border border-red-100 flex items-center justify-between">
              ...
              <button type="button" onClick={() => setNotice("Datchik tekshirish amali hozircha demo. IoT backend ulanmagan.")} className="text-[10px] font-bold text-white bg-red-500 hover:bg-red-600 px-2 py-1 rounded shadow-sm">Tekshirish</button>
            </div>
          </div>
