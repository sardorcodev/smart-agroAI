      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-7 space-y-6">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
            <h3 className="text-lg font-bold text-slate-800 mb-6 flex items-center gap-2"><MessageSquare className="text-blue-500"/> Chipta (Ticket) Ochish <DemoBadge /></h3>
            ...
            <form className="space-y-4">
              <div>
                <label htmlFor="support-topic" className="text-xs font-bold text-slate-500 block mb-1 uppercase">Mavzu</label>
                <select id="support-topic" className="w-full bg-slate-50 border border-slate-200 rounded-lg p-3 text-sm font-semibold outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20">
              ...
              <div>
                <label htmlFor="support-message" className="text-xs font-bold text-slate-500 block mb-1 uppercase">Xabar matni</label>
                <textarea id="support-message" rows="4" className="w-full bg-slate-50 border border-slate-200 rounded-lg p-3 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 resize-none" placeholder="Muammoni batafsil ta'riflang..."></textarea>
              </div>
              <button
                type="button"
          ...
          <div className="space-y-3">
            {faqs.map((faq, index) => (
              <div key={index} className="border border-slate-100 rounded-xl overflow-hidden">
                <div className="w-full bg-slate-50 p-4 text-left flex justify-between items-center">
